#-----------------------[ INFO-CODE ]-----------------------#
"""Open By   : Tajul Islam Rabb [BHOOT-CYBER]
Developer : Tajul Islam Rabbi
Github    : Hacker1414
Status    : Rabbi Free Command"""
#-----------------------[ IMPORT-CODE ]-----------------------#
import os
import sys
...
{line_x}\n (+) Developer : Bhoot Rabbi Islam\n (+) Facebook  : Tajul Islam Rabbi\n (+) Github    : Hacker1414\n (+) Status    : Open Rabbi Free Command\n{line_x}"""
#-----------------------[ CLEAR-CODE ]-----------------------#
...
def Main():
    ...
    elif manu in ['2','02']:os.system('xdg-open https://www.facebook.com/profile.php?id=100072425385396');Main()
    else:Main()
#-----------------------[ COUNTRY-CODE ]-----------------------#
def country():
